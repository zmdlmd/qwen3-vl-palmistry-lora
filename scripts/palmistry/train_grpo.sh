...
IMPORTANCE_SAMPLING_LEVEL="${IMPORTANCE_SAMPLING_LEVEL:-token}"
SAPO_TEMPERATURE="${SAPO_TEMPERATURE:-4.0}"
SAPO_CENTER="${SAPO_CENTER:-1.0}"
SAPO_MIN_WEIGHT="${SAPO_MIN_WEIGHT:-0.2}"
...
CMD=(
  ...
  --sapo_center "${SAPO_CENTER}"
  --sapo_min_weight "${SAPO_MIN_WEIGHT}"
)
