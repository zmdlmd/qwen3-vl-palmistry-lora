...
if [[ -n "${GATE_CLASSIFIER_PATH}" ]]; then
  CMD+=(--gate-classifier-min-confidence "${GATE_CLASSIFIER_MIN_CONFIDENCE}")
  CMD+=(--gate-classifier-continue-min-confidence "${GATE_CLASSIFIER_CONTINUE_MIN_CONFIDENCE}")
  CMD+=(--gate-classifier-retake-min-confidence "${GATE_CLASSIFIER_RETAKE_MIN_CONFIDENCE}")
  CMD+=(--gate-classifier-min-margin "${GATE_CLASSIFIER_MIN_MARGIN}")
fi
